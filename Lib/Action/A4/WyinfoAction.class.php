...
class WyinfoAction extends CommonAction {
	...
	Public function index(){
		$mt=M("message_type");
		$result=$mt->where("xiaoqu_id = %d AND aflag ='%s' AND is_delete = %d ",$this->xiaoqu_id,$this->forumlist['WY_INFO'],0)->order("sort")->select();
	...
	public function add_message(){
		...
		$data['is_top']=$_POST['top'] ? $_POST['top'] : 0;
		$data['details']= $_POST['details'];
		$data['is_diaplay_click']=$_POST['is_viewcount'] ? : 0;
		$data['aid']=$_POST['aid'];
		$data['is_delete']=0;
